    ...
    <div className="af-login-page">
      ...
      <div className="af-login-card">
        ...
        <div className="af-login-brand">
          ...
          <div className="af-login-appname">{t('shell.appName')}</div>
        ...
        {step === 'credentials' ? (
          ...
          <form onSubmit={submitOtp} className="space-y-4">
            <p className="text-sm" style={{ color: 'var(--al-text-2)' }}>{t('login.otpSentPrefix')} <span style={{ color: 'var(--al-text)' }}>{email}</span></p>
