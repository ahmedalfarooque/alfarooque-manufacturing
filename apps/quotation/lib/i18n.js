...
export const translations = {
  en: {
    ...
    'quote.notFound': 'This quotation was not found — it may have been deleted.',
    'quote.backToList': '← Back to Quotations',
    ...
    'catalogue.notFound': 'This product was not found — it may have been deleted.',
    'catalogue.backToList': '← Back to Catalogue',
  ...
  ar: {
    ...
    'quote.notFound': 'لم يتم العثور على عرض السعر هذا — ربما تم حذفه.',
    'quote.backToList': '→ العودة إلى عروض الأسعار',
    ...
    'catalogue.notFound': 'لم يتم العثور على هذا المنتج — ربما تم حذفه.',
    'catalogue.backToList': '→ العودة إلى الكتالوج',
