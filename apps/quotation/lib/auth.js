...
/* Auth core for the Quotation app — identical shape to apps/projects/lib/auth.js,
   scoped to app='quotation' so a Quotation session is independent of the
   Cars/Projects sessions even though all share the platform_users table. */
...
function readSession(req) {
  ...
  /* SSO fallback — an Admin already signed into a sibling app (Projects/
  ...
  /* Super admin override (one master account, unrestricted everywhere) —
     enforced here so it cascades through every adminOnly/qrole check
