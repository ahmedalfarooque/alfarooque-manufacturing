...
const DEFS = {
  ...
  materials: {
    ...
    columns: [
      ...
      C('material_type', 'Type', 'الصنف', true), C('thickness', 'Thickness', 'السماكة'),
      C('size_text', 'Size', 'المقاس'), C('unit', 'Unit', 'الوحدة'), C('brand', 'Brand', 'الماركة'),
      C('latest_price', 'Price (SAR)', 'السعر (ر.س)'), C('default_waste_pct', 'Waste %', 'الهدر ٪'),
      C('status', 'Status', 'الحالة'), C('notes', 'Notes', 'ملاحظات', true),
    ],
    example: { code: 'M-00001', name: 'ام دي اف 18مم', kind: 'material', thickness: '18mm', size_text: '122x244', unit: 'sheet', latest_price: 185, default_waste_pct: 10, status: 'active' },
  },
  customers: {
