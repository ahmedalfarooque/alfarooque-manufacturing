...
const STYLES = {
  draft: 'bg-[color:var(--bd-2)] text-[color:var(--tx-3)]',
  ...
  expired: 'bg-[#ef4444]/10 text-[#ef4444]/80',
  superseded: 'bg-[color:var(--bd-2)] text-[color:var(--tx-3)] line-through',
  cancelled: 'bg-[color:var(--bd-2)] text-[color:var(--tx-3)]',
  ...
  pr_rejected: 'bg-[#ef4444]/15 text-[#ef4444]',
