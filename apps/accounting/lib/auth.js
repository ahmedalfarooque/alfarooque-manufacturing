...
/* Auth core for the Accounting app — same hardened shape as sibling apps,
   scoped to app='accounting' so an Accounting session is independent even
   though all apps share the platform_users identity table. */
...
function readSession(req) {
  ...
  /* SSO fallback — a user already signed into a sibling app is accepted
     here without a second login. Extended to all authenticated roles so
     Warehouse Managers and other non-admin staff can cross apps. */
