...
export const metadata = {
  title: 'Accounting — AL FAROOQUE',
  description: 'Accounting & Finance Management for AL FAROOQUE Manufacturing',
  icons: { icon: '/logo.png' },
};
      ...
      <head>
        <script
          dangerouslySetInnerHTML={{
            __html: `(function(){try{function c(n){var m=document.cookie.match(new RegExp('(?:^|;\\\\s*)'+n+'=([^;]*)'));return m?decodeURIComponent(m[1]):null;}var t=c('af_theme')||localStorage.getItem('af-accounting-theme');if(t==='dark'){document.documentElement.classList.add('dark');}var l=c('af_lang')||localStorage.getItem('af-accounting-lang');if(l==='ar'){document.documentElement.lang='ar';document.documentElement.dir='rtl';}}catch(e){}})();`,
          }}
        />
      </head>
