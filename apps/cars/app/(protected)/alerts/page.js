  ...
  return (
    <Shell active="/alerts">
      ...
      {!alerts ? (
        ...
        <div className="rounded-xl border border-black/5 dark:border-white/10 bg-white dark:bg-white/[0.03] p-8 text-center text-slate-400 text-sm">No alerts yet.</div>
      ) : (
